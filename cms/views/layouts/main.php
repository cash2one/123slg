    ...
    <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            <ul class="am-list admin-sidebar-list" id="collapase-nav-1">
                ...
                <li class="am-panel">
                    <a data-am-collapse="{parent: '#collapase-nav-1', target: '#cms-nav'}">
                        <i class="am-icon-hashtag am-margin-left-sm"></i>官网管理<i class="am-icon-angle-right am-fr am-margin-right"></i>
                    </a>
                    <ul class="am-list am-collapse admin-sidebar-sub" id="cms-nav">
                        <li><a href="<?php echo Url::to(['/game/index'])?>"><span class="am-icon-table"></span>游戏官网</a></li>
                        <li><a href="<?php echo Url::to(['/column/index'])?>"><span class="am-icon-first-order"></span>栏目管理</a></li>
                        <li><a href="<?php echo Url::to(['/article/index'])?>"><span class="am-icon-deaf"></span>文章管理</a></li>
                        <li><a href="<?php echo Url::to(['/index/images'])?>" target="_blank"><span class="am-icon-deaf"></span>图片上传</a></li>
                    </ul>
                </li>
