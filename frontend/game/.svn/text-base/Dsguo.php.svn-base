...
class Dsguo extends GameApi
{
    const KEY = '88432jr86an750g698mhfu564kdg5250jr5678542gst588';
    const AGENT = 'slg123';
    ...
    public function login(array $data)
    {
        ...
        return "http://sglogin.123slg.com/login_slg123.php?agent=" . self::AGENT . "&username={$username}&server_id={$server_id}&cm_flag={$cm_flag}&time={$time}&sum={$sum}";
    }
    ...
    public function pay($data)
    {
        ...
        $url = "http://sgpay.123slg.com/pay.php?agent=" . self::AGENT . "&user_id={$user_id}&server_id={$server_id}&order_id={$order_id}&amount={$amount}&timestamp={$timestamp}&sign={$sign}";
